...
class ProfileForm(forms.ModelForm):
    first_name = forms.CharField(label='Nombre del empleado', widget=forms.TextInput(attrs={'class': 'form-control'}))
    last_name = forms.CharField(label='Apellido del empleado', widget=forms.TextInput(attrs={'class': 'form-control'}))
    class Meta:
        model = Profile
        # Añadimos identificacion y direccion que faltaban
        fields = ['first_name', 'last_name', 'tipo_identificacion', 'identificacion', 'direccion', 'telefono', 'imagen']
        labels = {
