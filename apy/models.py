...
# ------------------------------------------------------------------
# MÓDULOS DE RESPALDO Y ADMINISTRACIÓN DE SISTEMA
# ------------------------------------------------------------------

class ConfiguracionRespaldo(models.Model):
    """
    Guarda la configuración del respaldo automático. Solo debe existir 1 registro.
    """
    FRECUENCIA_OPCIONES = [
        ('diario', 'Diario'),
        ('semanal', 'Semanal'),
    ...
    # Se puede añadir un campo para el destino (local, cloud) si lo necesitas
...
class BackupLog(models.Model):
    """
    Registro histórico de cada copia de seguridad (Backup).
    """
    TIPO_OPCIONES = [
        ('Manual', 'Manual'),
    ...
    # El campo usuario apunta al usuario de Django (models.User, ya importado)
    ...
    class Meta:
        ...
        ordering = ['-fecha_inicio'] # Ordenar por fecha más reciente
