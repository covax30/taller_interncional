...
INSERT INTO `apy_module` VALUES (1,'Clientes','Gestión de información de clientes.'),(2,'Vehiculos','Gestión de la flota de vehículos.'),(3,'Entrada Vehiculo','Registro de ingreso de vehículos al taller.'),(4,'Salida Vehiculo','Registro de egreso y diagnóstico de vehículos.'),(5,'Caja','Registro de movimientos de caja (Ingresos/Gastos).'),(6,'Gastos','Registro y gestión de gastos'),(7,'Compra','Registro de las compras a proveedores.'),(8,'Tipo Mantenimiento','Definición de tipos de mantenimiento (ej: cambio de aceite).'),(9,'Mantenimiento','Gestión de fallas y procesos de reparación de vehículos.'),(10,'Marca','Gestión de marcas de repuestos y herramientas.'),(11,'Repuestos','Gestión del inventario de repuestos.'),(12,'Herramientas','Gestión del inventario de herramientas.'),(13,'Insumos','Gestión del inventario de insumos (líquidos, etc.).'),(14,'Informes','Generación y consulta de informes de mantenimiento.'),(15,'Administradores','Gestión de administradores/gerentes.'),(16,'Empleados','Gestión de información del personal.'),(17,'Nomina','Gestión y registro de pagos de nómina.'),(18,'Proveedores','Gestión de información de proveedores.'),(19,'Pagos','Registro de pagos a proveedores y otros egresos.'),(20,'Servicios Públicos','Registro de pagos de servicios públicos (Luz, Agua, Gas).'),(21,'Facturación','Generación y consulta de facturas a clientes.');
...
CREATE TABLE `apy_permission` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `apy_permission_user_id_module_id_305f0955_uniq` (`user_id`,`module_id`),
...
INSERT INTO `apy_permission` VALUES (1,1,1,1,1,5,2),(2,1,1,1,1,1,1),(3,1,1,1,1,2,1),(4,1,1,1,1,3,1),(5,1,1,1,1,4,1),(6,1,1,1,1,5,1),(7,1,1,1,1,6,1),(8,1,1,1,1,7,1),(9,1,1,1,1,8,1),(10,1,1,1,1,9,1),(11,1,1,1,1,10,1),(12,1,1,1,1,11,1),(13,1,1,1,1,12,1),(14,1,1,1,1,13,1),(15,1,1,1,1,14,1),(16,1,1,1,1,15,1),(17,1,1,1,1,16,1),(18,1,1,1,1,17,1),(19,1,1,1,1,18,1),(20,1,1,1,1,19,1),(21,1,1,1,1,20,1),(22,1,1,1,1,21,1);
...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$1000000$nNaxYFlkyghOEWTIgBHZV6$Sn2Jol+plxlFJHRtv9MIxCRdgn29RrLNX61iUdZyeMY=','2025-12-04 14:44:23.570480',1,'erick','','','erickcovisfero@gmail.com',1,1,'2025-10-31 16:17:51.142945'),(2,'pbkdf2_sha256$1000000$vQu9IeE576g9kkfcAjDNUr$dOUFPgNjD/ItjyhKgem+rC3zFgq+C5AfXhAYHUdVigk=','2025-12-01 16:38:08.966725',0,'jose','','','josecovis@gmail.om',0,1,'2025-12-01 16:08:38.493521');
...
