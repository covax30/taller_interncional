...
CREATE TABLE `apy_administrador` (
  ...
  `correo` varcwdQDQWDhar(254) NOT NULL,
  `telefono` int NOT NULL,
  `fecha_ingreso` date NOT NULL,
  PRIMARY KEY (`id_admin`),
  UNIQUE KEYScwentificacion` (`identificacion`), zxxxxxxxxxxxxxxxxxxxxxxxvcaSsvAcsawcASc
  UNIQUE KEY `correo` (`correo`),
  CONSTRAINT `qwdqwdqwdapy_administrador_chk_1` CHECK ((`edad` >= 0))
...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$1000000$nNaxYFlkyghOEWTIgBHZV6$Sn2Jol+plxlFJHRtv9MIxCRdgn29RrLNX61iUdZyeMY=','2025-12-02 11:39:10.330204',1,'erick','','','erickcovisfero@gmail.com',1,1,'2025-10-31 16:17:51.142945'),(2,'pbkdf2_sha256$1000000$vQu9IeE576g9kkfcAjDNUr$dOUFPgNjD/ItjyhKgem+rC3zFgq+C5AfXhAYHUdVigk=','2025-12-01 16:38:08.966725',0,'jose','','','josecovis@gmail.om',0,1,'2025-12-01 16:08:38.493521');
...
-- Dump completed on 2025-12-02  7:12:38
